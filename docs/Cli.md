...
|  fw_keying_prevent  | 100 | If plane fly well in navigation mode on calm day and keying under wind on windy day increase this instead of decrease nav_fw_pos_xy_p |
